...
export default [
  ...
  {img:rps, name:'Stone-Paper-Scissor Game', deploy:'https://stone-paper-scissor-game-navy.vercel.app', repo: 'https://github.com/SaanCaba/stone-paper-scissor-game', info:'App realizada sobre el juego de piedra papel o tijera, en el cual implementé Next.JS como herramienta principal además de TypeScript.', tecnologias:'NextJS, TypeScript'}
];
